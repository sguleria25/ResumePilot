...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A focused resume builder. Fill in your details and export a professionally typeset PDF." },
      { property: "og:title", content: "Resumé Studio" },
      { property: "og:description", content: "Build a polished, professional resume and export to PDF." },
